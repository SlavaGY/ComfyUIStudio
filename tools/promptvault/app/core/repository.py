...
from app.core.generation_filter import FilterOptions, GenerationFilterSQL
from app.core.generation_sorter import GenerationSorterSQL
from app.core.parser import parse_generation_data
from app.core.sort_options import SortMode
from app.core.statistics import HistogramBucket, Statistics
...
class GenerationRepository:
    ...
    def export_generations_zip(
        ...
        from app.core.thumbnails import make_thumb
